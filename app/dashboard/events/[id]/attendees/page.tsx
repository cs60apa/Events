...
export default function EventAttendeesPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case "attended":
        return <Badge variant="secondary" className="bg-green-100 text-green-800">Attended</Badge>;
      case "cancelled":
  ...
  if (!user || user.role !== "organizer") {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600">Only event organizers can view attendee lists.</p>
      </div>
    );
  }
  ...
  if (event.organizer?._id !== user._id) {
    return (
      <div className="text-center py-12">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">Access Denied</h2>
        <p className="text-gray-600">You can only view attendees for your own events.</p>
      </div>
    );
  }
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center space-x-2 mb-1">
                            <h3 className="text-lg font-semibold">{registration.user?.name}</h3>
